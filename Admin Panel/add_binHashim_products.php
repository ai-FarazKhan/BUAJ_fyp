...
<div class="container-fluid">
  <h1 class="display-3 text-center" style="font-family: 'Lobster', cursive;">Add your BinHashim Products.</h1>
</div>
<br>
<br>
<br>
  ...
  <?php
    ...
    $query = "SELECT * FROM binhashim_prices";
...
?>
  ...
  <?php while($row = $running_query->fetch_array()):?>
    <tr>
      ...
      <td><a class="text-white" href="Edit_BinHashim_Product_Price.php ?id=<?php echo $row['id'];?>"><?php echo $row['itemName'];?></a></td>
...
<form action="" method="POST">
    <button type="submit" name="submit" class="btn btn-outline-primary btn-lg btn-block">Delete All BinHashim Products</button>
</form>
...
$sum_Query ="SELECT SUM(itemPrice) FROM binhashim_prices;";
...
$setting_connection = mysqli_connect($server_Name,$user_Name,$user_Pass,$db_name);
    ...
    {
        $query2 = "TRUNCATE TABLE binhashim_prices"; 
        mysqli_query($setting_connection,$query2);
        // header('location: add_binHashim_products.php');
        echo "<script type='text/javascript'>window.top.location='add_binHashim_products.php';</script>";
    }
    if(isset($_POST['add_btn']))
    {
        ...
        if($taking_product_name_input == '' && $taking_product_price_input == '')
        {
            ...
            $query3 = "INSERT INTO binhashim_prices (itemName,itemPrice) VALUES('$taking_product_name_input','$taking_product_price_input')";
...
<div class="form-group">
  <label style="color:#f0ff00; font-size: 30px;">Add Your BinHashim Products</label>
