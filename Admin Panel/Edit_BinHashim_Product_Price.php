...
<div class="container-fluid">
  <h1 class="display-3 text-center" style="font-family: 'Lobster', cursive;">Welcome To Edit BinHashm Price Section.</h1>
</div>
<br>
<br>
<br>
...
$setting_connection = mysqli_connect($server_Name,$user_Name,$user_Pass,$db_name);
    ...
    $query1 = "SELECT * FROM binhashim_prices WHERE id = '$getting_id_of_metro_product'"; 
    $running_query1 = mysqli_query($setting_connection,$query1);
  

    if(isset($_POST['delete_btn']))
    {
        $query2 = "DELETE FROM binhashim_prices WHERE id = '$getting_id_of_metro_product'";
    ...
    if(isset($_POST['update_btn']))
    {
        ...
        if($taking_input_Product_Name == '' && $taking_input_Product_Price == '')
        {
            ...
            $query3 = "UPDATE binhashim_prices SET itemName = '$taking_input_Product_Name', itemPrice = '$taking_input_Product_Price' WHERE id = ('$getting_id_of_metro_product')";
