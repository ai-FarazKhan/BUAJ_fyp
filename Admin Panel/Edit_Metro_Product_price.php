  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <br>
        ...
        <button type="button" class="btn btn-lg btn-light" disabled>Welcome Mr.<?php echo $_SESSION['userLoginName']?> To Edit Metro Price Section <i class="fas fa-eye" style="color:green;"></i></button>
        </li>
        <li class="nav-item active" style="padding-right: 10px; padding-top: 10px;">
...
<div class="container-fluid">
  <h1 class="display-3 text-center" style="font-family: 'Lobster', cursive;">Welcome To Edit Metro Price Section.</h1>
</div>
<br>
<br>
<br>
...
$setting_connection = mysqli_connect($server_Name,$user_Name,$user_Pass,$db_name);
    ...
    $query1 = "SELECT * FROM metro_prices WHERE id = '$getting_id_of_metro_product'"; 
    $running_query1 = mysqli_query($setting_connection,$query1);
  

    if(isset($_POST['delete_btn']))
    {
        $query2 = "DELETE FROM metro_prices WHERE id = '$getting_id_of_metro_product'";
    ...
    if(isset($_POST['update_btn']))
    {
        ...
        if($taking_input_Product_Name == '' && $taking_input_Product_Price == '')
        {
            ...
            $query3 = "UPDATE metro_prices SET itemName = '$taking_input_Product_Name', itemPrice = '$taking_input_Product_Price' WHERE id = ('$getting_id_of_metro_product')";
